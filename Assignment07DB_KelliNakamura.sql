...
-- 2021-02-24,KNakamura,Created File
-- 2021-02-24,KNakamura,Created Database and Tables
-- 2021-02-24,KNakamura,Added Constraints
-- 2021-02-24,KNakamura,Inserted Data
-- 2021-02-28,KNakamura,Created Views/Functions for Assignment 07
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_KelliNakamura')
	 Begin 
	  Alter Database [Assignment07DB_KelliNakamura] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_KelliNakamura;
	 End
	Create Database Assignment07DB_KelliNakamura;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_KelliNakamura;
...
Select * From vProductInventories 
 Order By ProductName, datepart(mm,InventoryDate), InventoryCount;
Go 
...
Create View vProductInventoriesWithPreviousMonthCounts 
 As 
  Select ProductName
       , InventoryDate
       , InventoryCount
       , iif(month(InventoryDate) = 1, 0, lag([InventoryCount]) Over (Order By ProductName, cast(InventoryDate as Date))) as PreviousMonthCount
...
Order By Year(Cast(InventoryDate as Date))); 
  --does not work with Order By in the function because I didn't use a Top in my select statement. 
  --Per Randal's lecture notes, order bys in views and functions are not recommended or best practice
  --Instead, Randal's notes recommended placing order bys in the select statment when obtaining the result set.
Go
*/
